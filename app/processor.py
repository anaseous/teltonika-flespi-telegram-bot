...
def process_telemetry(t):
    device_id,ts,lat,lon,speed,ignition,towing=t['device_id'],t['ts'],t['lat'],t['lon'],t['speed'],t['ignition'],t['towing']; insert_telemetry(device_id,ts,lat,lon,speed,ignition,towing,t['raw'])
